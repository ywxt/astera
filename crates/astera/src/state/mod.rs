...
use smithay::{
    ...
    delegate_foreign_toplevel_list, delegate_idle_inhibit, delegate_keyboard_shortcuts_inhibit,
...
pub struct Astera {
    ...
    active_fractional_scale_surfaces: HashSet<WlSurface>,
...
impl Astera {
    ...
    fn new_with_clock(display: &DisplayHandle, config: Config, clock: Arc<dyn Clock>) -> Self {
        ...
        Self {
            ...
            active_fractional_scale_surfaces: HashSet::new(),
